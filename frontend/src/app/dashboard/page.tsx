...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel("aegisguard-init_sweeps_changes")
      .on(
        "postgres_changes",
        { event: "*", schema: "public", table: "aegisguard-init_sweeps" },
        () => {
          fetch("/api/sweep")
            .then((res) => res.json())
            .then((data) => {
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 stagger-children">
            {error ? (
              <div className="col-span-full rounded-2xl glass p-8 text-center border-sol-red/20 shadow-lg shadow-sol-red/5">
                ...
                <div className="text-sol-muted mb-6">Failed to connect to the AegisGuard.init migration engine.</div>
                <button
