...
<p align="center">
  <a href="https://aegisguard-init.edycu.dev/">
    <img src="docs/screenshots/AegisGuard.init_Thumbnail_16_9.png" alt="AegisGuard.init Project Banner" width="800" />
  </a>
</p>

<h1 align="center">AegisGuard.init</h1>
...
<p align="center">
  <a href="https://aegisguard-init.edycu.dev/"><img src="https://img.shields.io/badge/Live_Demo-▶_aegisguard-init.edycu.dev-00ffaa?logo=vercel" alt="Live Demo" /></a>
...
AegisGuard.init is an autonomous migration engine built for the **[DoraHacks Boring AI Hackathon 2026](https://dorahacks.io/hackathon/boring-ai)**. It upgrades legacy Solana codebases from `@solana/web3.js` to the modern `@solana/kit` standard — combining deterministic AST transforms with a compiler-in-the-loop AI for edge cases that mechanical regex can't handle.

<table>
  <tr>
    <td width="50%" align="center">
      <img src="docs/screenshots/dashboard.png" alt="AegisGuard.init Dashboard" />
      <br/>
      <em>Dashboard — Real-time sweep monitoring</em>
    </td>
    <td width="50%" align="center">
      <img src="docs/screenshots/sweep-detail.png" alt="AegisGuard.init Pipeline Detail" />
      <br/>
...
**AegisGuard.init** takes a radically different approach: **compiler-verified AI migration.**
...
<p align="center">
  <img src="docs/architecture.png" alt="AegisGuard.init Architecture" width="720" />
</p>
...
├── codemod/                  # AegisGuard.init's core codemod plugin package
├── package.json
├── tsconfig.json
└── next.config.ts
```
...
**Core Thesis:** AI migrations are broken because LLMs hallucinate syntax. By constraining the AI to only fix compiler-verified errors (not generate code from scratch), AegisGuard.init achieves **zero false positives** — making it genuinely "boring" in the best possible way.
