...
const AUDIO_PATH = '/Users/edycu/Projects/DemoStudio/public/projects/AegisGuard.init/demo_audio.mp3';

async function runDemo() {
  console.log('🚀 Starting AegisGuard.init Demo Recording Script...');
  ...
  if (videoPath) {
    const finalPath = path.join('/Users/edycu/Projects/DemoStudio/public/projects/AegisGuard.init', 'AegisGuard.init_Demo.webm');
