...
async function runBRoll() {
  console.log('🎥 Starting AegisGuard.init B-Roll Recording...');
  ...
  if (videoPath) {
    const finalPath = path.join('/Users/edycu/Projects/DemoStudio/public/projects/AegisGuard.init', 'AegisGuard.init_BRoll.webm');
